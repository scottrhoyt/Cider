#
#  Be sure to run `pod spec lint SwiftyTextTable.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "Cider"
  s.version      = "0.9.0"
  s.summary      = "The missing Apple Music SDK. Written in Swift."
  ...
  s.source_files  = "Sources/Cider/**/*.swift"
